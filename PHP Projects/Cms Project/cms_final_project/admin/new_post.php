            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div id="admin-index-form">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        Post Title:
                        <input type="text" name="post_title" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Post Title"><br>
                        Post Category:
                        <select name="post_category" class="form-control" id="exampleFormControlSelect2">
                        ...
                        Post Keywords:
                        <input type="text" name="post_keywords" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Post Keywords"><br>
                                        ...
                                        if($fileErr === 0){
                                            if($fileSize < 3000000){
                                                ...
                                                if(mysqli_query($con, $sql)){
                                                    ...
                                                    header("Location: new_post.php?message=Error");
                                                }
                                            } else{
                                                header("Location: new_post.php?message=Maximum 3 mb file size are allowed.");
                                                exit();
                                            }
                                        } else{
                                            header("Location: new_post.php?message=Oops, There is an error in uploading file");
                                            exit();
                                        }
                                } else{
                                    header("Location: new_post.php?message=Only jpg, jpeg and png Formats are allowed.");
                                    exit();
                                }
                            }
